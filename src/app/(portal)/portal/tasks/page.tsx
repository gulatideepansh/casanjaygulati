      ...
      <section className="border-t border-[#e5dfd3] py-6 first:border-t-0">
        <div>
          ...
          <div className="mt-8 border-y border-[#e5dfd3]">
            <div className="hidden grid-cols-[1.05fr_0.8fr_0.55fr_0.65fr_0.7fr_0.8fr_0.55fr] gap-5 border-b border-[#e5dfd3] px-4 py-4 text-sm font-semibold text-slate-600 lg:grid">
              <span>Task</span>
